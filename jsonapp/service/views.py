...
from .models import Service, Category, Wilaya, Createservice
...
def categoryservice(request, pk):
    ...
    context = {"category": category, "service": service, "wilaya": wilaya}
...
def categoryDetail(request, pk):
    ...
    context = {"service": service, "counter": counter}
